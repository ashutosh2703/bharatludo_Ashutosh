            ...
            <div className='leftContainer responsive-login-container'>
                <div className="main-area bg-dark">
                    ...
                    <div className="login-footer">
                        By continuing I agree that MaxwayInfotechLudo. may store and process my data in accordance with the <Link to="/term-condition">Terms of Use</Link>, <Link to="/PrivacyPolicy">Privacy Policy</Link> and that I am 18 years or older. I am not playing from
