...
const Profile1 = () => {
  ...
  return (
    <>
      <Header user={profile} />
      <div className="leftContainer" style={{ minHeight: "100vh", padding: "3rem 2rem" }}>
        <div
          className="mt-5 py-4 px-3"
          style={{
            backgroundImage: `url("/Images/LandingPage_img/myprofile_banner.jpg")`,
            border: "1px solid black",
            borderRadius: "10px"
          }}

        >
          <div className={`${css.center_xy}`} style={{flexDirection:"row" , justifyContent: "space-evenly"}} >
            <label>
              <input
                className="d-none"
                type="file"
                ...
                <div>
                  <div className="" style={{}}>
                    <Link className={`d-flex align-items-center ${css.profile_wallet} bg-light mx-1 my-4 py-5`} style={{ backgroundColor: 'whitesmoke' }} to={(profile && profile.verified === `unverified`) ? `/Kyc2` : `/Profile`}>
                      <picture className="ml-4">
                        <img width="50px" src={process.env.PUBLIC_URL + "/Images/kyc-icon-new.png"} alt="" className="" />
                      </picture>
        ...
        {profile && !profile.referral && (
          <div className="py-1">
            <div
              ...
              style={{ height: "84px", border: "1px solid black", borderRadius: "20px", padding: "1rem", marginTop: "0.5rem" }}
            >
              <picture>
                <img
                  height="32px"
        ...
        <div className="px-5 py-1">
          <div
            className={`d-flex align-items-center ${css.position_relative}`}
            style={{ height: "84px", backgroundColor: "#DCB745", border: "1px solid black", padding: "1rem", borderRadius: "20px" }}
          >
            <picture>
              <img
                height="40px"
              ...
              <div className="">
                <picture className="mr-1">
                  <img
                    ...
                    width="21px"
                    src={
                      process.env.PUBLIC_URL + "/Images/global-rupeeIcon.png"
                    }
                    alt=""
                    className="snip-img"
                  />
        ...
        <div className="px-5 py-1">
          <div
            className={`d-flex align-items-center ${css.position_relative}`}
            style={{ height: "84px", backgroundColor: "#F77E7E", border: "1px solid black", padding: "1rem", borderRadius: "20px" }}
          >
            <picture>
              <img
                height="32px"
                width="36px"
                src={process.env.PUBLIC_URL + "/Images/battleplayed.png"}
                alt=""
                className=""
              />
            </picture>
        ...
        <div className="px-5 py-1">
          <div
            className={`d-flex align-items-center ${css.position_relative}`}
            style={{ height: "84px", backgroundColor: "#C8C8C8", border: "1px solid black", padding: "1rem", borderRadius: "20px" }}
          >
            <picture>
              <img
                height="32px"
