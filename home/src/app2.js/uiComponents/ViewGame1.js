        ...
        <div className='main-area' style={{ paddingTop: '60px' }}>
         {!Boolean(submitProcess) && <div className='battleCard-bg'>
            <div className='battleCard'>
              <div className='players cxy pt-2'>
                <div className='flex-column cxy'>
                  ...
                  {Game.Created_by.avatar ? (<img
                    src={baseUrl+`${Game.Created_by.avatar}`} onError={(e)=>{e.target.onerror = null; e.target.src="https://MaxwayInfotechLudo.in/user.png"}}
              ...
              {console.log(Game.Room_code , "roomcode")}
